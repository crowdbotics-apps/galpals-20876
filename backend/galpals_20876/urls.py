"""galpals_20876 URL Configuration
...
admin.site.site_header = "GalPals"
admin.site.site_title = "GalPals Admin Portal"
admin.site.index_title = "GalPals Admin"

# swagger
api_info = openapi.Info(
    title="GalPals API",
    default_version="v1",
    description="API documentation for GalPals App",
)
